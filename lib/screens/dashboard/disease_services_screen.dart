...
class DiseaseServicesScreen extends StatefulWidget {
  final Disease disease;

  const DiseaseServicesScreen({super.key, required this.disease});

  @override
  State<DiseaseServicesScreen> createState() => _DiseaseServicesScreenState();
}

class _DiseaseServicesScreenState extends State<DiseaseServicesScreen> {
  @override
  void initState() {
    super.initState();
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            floating: false,
            pinned: true,
            backgroundColor: widget.disease.color,
            leading: IconButton(
            ...
            if (provider.isLoading && tests.isEmpty)
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Map LabTest to the legacy Service model temporarily expected by ServiceDetailsScreen
